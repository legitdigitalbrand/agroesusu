  ...
  return (
    <div className="min-h-screen bg-paper">
      <div className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="font-serif text-3xl text-ink mb-2">Terms of Service</h1>
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-ink">
          ...
          <section>
            <h2 className="font-serif text-xl text-ink">2. Description of Service</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-ink">3. User Accounts</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-ink">4. Eligibility</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-ink">5. Prohibited Conduct</h2>
          ...
          <section>
            <h2 className="font-serif text-xl text-ink">6. Limitation of Liability</h2>
