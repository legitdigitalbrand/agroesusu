...
const categories = [
  {
    ...
    faqs: [
      {
        question: 'What is AgroPocket?',
        answer: 'AgroPocket is a digital agricultural savings and credit platform designed specifically for Nigerian farmers, cooperatives, and agribusinesses. We help you automate your individual or group savings, earn high interest, and access fair, harvest-aligned loans.',
      },
      {
        question: 'How do I access AgroPocket without internet access?',
        answer: 'You can easily access AgroPocket from anywhere in Nigeria on any basic phone by dialing *347*88#. Our secure USSD channel lets you check balances, make cooperative payments, save, and apply for loans without any data or internet.',
      },
      {
        question: 'What are the charges for using AgroPocket?',
        answer: 'AgroPocket has zero hidden maintenance fees, zero account opening fees, and zero card management fees. We keep our fees completely transparent and as low as possible to support the local food system.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      {
        question: 'How do I qualify for an agricultural loan on AgroPocket?',
        answer: 'To qualify for our seed and input loans, you must be a registered member of AgroPocket and have a verified profile (including BVN verification). Active savings history or being part of an approved, active agricultural cooperative group dramatically improves your loan approval odds.',
      },
      {
      ...
      {
        question: 'Does AgroPocket require collateral for loans?',
  ...
  },
  {
    ...
    faqs: [
      {
        question: 'Is my money safe with AgroPocket?',
