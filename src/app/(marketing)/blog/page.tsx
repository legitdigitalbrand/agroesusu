...
const posts = [
  ...
  },
  {
    ...
    excerpt: 'A comprehensive guide explaining how AgroPocket partners with insurance companies to automatically protect farmers from rainfall deficits and sudden flash flooding.',
      ...
      <section className="bg-gradient-to-b from-parchment/80 to-paper py-16 md:py-24 border-b border-line">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-ink tracking-tight max-w-3xl mx-auto">
            The AgroPocket Agribusiness & Finance Blog
          </h1>
