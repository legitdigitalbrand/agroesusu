...
export default function Homepage() {
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-b from-brand-cream/80 via-white to-white pt-20 pb-24 md:pt-28 md:pb-32">
        <div className="absolute inset-0 z-0 opacity-40">
          <div className="absolute top-10 left-10 w-72 h-72 rounded-full bg-brand-primary/10 blur-3xl"></div>
          <div className="absolute bottom-10 right-10 w-96 h-96 rounded-full bg-brand-gold/10 blur-3xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <motion.div variants={fadeIn} className="inline-flex items-center space-x-2 bg-brand-primary/10 px-4 py-1.5 rounded-full border border-brand-primary/20">
                <span className="flex h-2 w-2 rounded-full bg-brand-primary animate-pulse"></span>
                <span className="text-sm font-semibold text-brand-primary">AgroEsusu Savings & Loans</span>
              </motion.div>
            ...
            >
              <div className="relative mx-auto max-w-sm lg:max-w-none">
                {/* Decorative Elements */}
                <div className="absolute -top-6 -left-6 w-12 h-12 bg-brand-gold rounded-xl rotate-12 -z-10 shadow-lg"></div>
                <div className="absolute -bottom-6 -right-6 w-20 h-20 bg-brand-primary rounded-full -z-10 blur-xl opacity-50"></div>
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 space-y-6 relative overflow-hidden">
                  <div className="flex justify-between items-center pb-4 border-b border-gray-100">
                    ...
                    <span className="bg-brand-primary/10 text-brand-primary text-xs font-bold px-2.5 py-1 rounded-lg">
                      +12.4% return
                    </span>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Circle Card */}
                    <div className="flex items-center justify-between p-3 bg-brand-cream rounded-xl border border-brand-gold/20">
                      ...
                      <span className="text-sm font-bold text-brand-primary">₦1,800,000</span>
                    </div>
                    ...
                    <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 space-y-2">
                      <div className="flex justify-between text-xs font-semibold">
                        ...
                        <span className="text-brand-primary font-bold">₦500,000 max</span>
                      </div>
      ...
      {/* Stats Section */}
      <section className="bg-brand-primary text-white py-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            {stats.map((stat, idx) => (
              ...
              >
                <div className="mx-auto bg-white/10 w-12 h-12 rounded-full flex items-center justify-center text-brand-gold mb-2">
                  <stat.icon className="h-6 w-6" />
                </div>
                <h3 className="text-3xl sm:text-4xl font-extrabold text-brand-gold">{stat.value}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 order-2 lg:order-1">
              <div className="bg-brand-cream border border-brand-gold/10 rounded-2xl p-6 space-y-6 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <span className="text-brand-primary text-xs font-semibold px-2 py-1 bg-brand-primary/5 rounded-lg">
                      12% Interest
                    </span>
                  </div>
            ...
            <div className="lg:col-span-7 order-1 lg:order-2 space-y-6">
              <div className="inline-flex items-center space-x-2 bg-brand-gold/10 px-3 py-1 rounded-full border border-brand-gold/20 text-brand-gold-dark text-sm font-semibold">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                {savingsFeatures.map((feat, idx) => (
                  <div key={idx} className="flex gap-3">
                    <div className="bg-brand-primary/10 text-brand-primary p-2 h-10 w-10 rounded-xl shrink-0 flex items-center justify-center">
              ...
              <div className="pt-4">
                <Link href="/savings-plans" className="inline-flex items-center font-bold text-brand-primary hover:text-brand-primary-dark transition-colors gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center space-x-2 bg-brand-primary/10 px-3 py-1 rounded-full border border-brand-primary/20 text-brand-primary text-sm font-semibold">
              ...
              <div className="pt-4">
                <Link href="/loan-plans" className="inline-flex items-center font-bold text-brand-primary hover:text-brand-primary-dark transition-colors gap-2">
            ...
            <div className="lg:col-span-5">
              <div className="bg-white border border-gray-100 shadow-lg rounded-2xl p-6 space-y-6">
                <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                  ...
                  <span className="text-xs text-brand-primary bg-brand-primary/5 px-2 py-0.5 rounded-lg font-bold">Fertilizer & Input Loan</span>
                </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <div className="bg-gray-100 h-2 rounded-full">
                      <div className="bg-brand-primary h-2 w-1/2 rounded-full"></div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="bg-gray-100 h-2 rounded-full">
                      <div className="bg-brand-gold h-2 w-3/5 rounded-full"></div>
                    </div>
                  </div>

                  <div className="border-t border-gray-100 pt-4 grid grid-cols-2 gap-4">
                    <div className="bg-brand-cream p-3 rounded-lg border border-brand-gold/10 text-center">
                      <p className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Monthly Repayment</p>
                      <h5 className="text-lg font-extrabold text-brand-primary mt-1">₦45,416</h5>
                    </div>
                    <div className="bg-brand-cream p-3 rounded-lg border border-brand-gold/10 text-center">
                      <p className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Interest Rate</p>
                      <h5 className="text-lg font-extrabold text-brand-gold-dark mt-1">1.5% <span className="text-xs font-normal">/mo</span></h5>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            {howItWorks.map((step, idx) => (
              ...
              >
                <div className="text-5xl font-extrabold text-brand-gold/20 group-hover:text-brand-gold/35 transition-colors absolute top-6 right-6">
                  {step.step}
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyChooseUs.map((item, idx) => (
              <div key={idx} className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-all space-y-4">
                <div className="bg-brand-primary/10 text-brand-primary p-3 rounded-lg w-12 h-12 flex items-center justify-center shrink-0">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-brand-primary to-brand-primary-dark text-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-8">
          ...
          >
            <Link href="/signup" className="btn-secondary bg-brand-gold text-gray-900 font-bold hover:bg-brand-gold-light py-4 px-8 text-base">
